...
<div class="not-prose rounded-xl border border-kumo-line bg-kumo-elevated/20 p-4">
  <div class="grid gap-3 sm:grid-cols-3">
    ...
    <div class="rounded-lg border border-orange-200 bg-orange-50 p-3">
      <div class="font-semibold text-orange-950">CloudboxRunner + Container</div>
      <p class="mt-1 text-sm leading-6 text-orange-900">A Durable Object fronts a Cloudflare Container. It clones repos, runs commands, verifies work, and returns logs, diff, artifacts, and runnerReceipts.</p>
    </div>
    <div class="rounded-lg border border-kumo-line bg-kumo-base p-3">
